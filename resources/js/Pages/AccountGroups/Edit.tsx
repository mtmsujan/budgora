...
export default function EditAccountGroup({ group }: Props) {
        ...
        <Layout>
            ...
            <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-slate-900">Edit Account Group</h1>
                    <p className="text-slate-600 mt-2">Update group details</p>
                </div>
