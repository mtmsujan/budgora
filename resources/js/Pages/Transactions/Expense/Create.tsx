...
export default function CreateExpense({ accounts, categories }: Props) {
        ...
        <Layout>
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="mb-8">
                    ...
                    <p className="text-slate-600 mt-2">Record a new expense transaction</p>
                </div>
                    ...
                    <form onSubmit={submit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-8 pr-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all outline-none"
                                        placeholder="0.00"
                                        required
                                    />
                                </div>
                        ...
                        <div className="flex gap-4 pt-4">
                            <button
                                type="submit"
                                disabled={processing}
                                className="flex-1 py-3 px-6 bg-gradient-to-r from-red-600 to-rose-600 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {processing ? 'Adding Expense...' : 'Add Expense'}
                            </button>
                            <Link
                                href="/dashboard"
