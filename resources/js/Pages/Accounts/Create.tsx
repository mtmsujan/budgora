...
export default function CreateAccount({ groups }: Props) {
        ...
        <Layout>
            ...
            <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="mb-8">
                    ...
                    <p className="text-slate-600 mt-2">Add a new account to track your finances</p>
                </div>
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="e.g., Cash, Checking Account"
                                required
                            />
                            {errors.name && (
